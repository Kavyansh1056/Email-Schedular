    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-brand-50 to-white px-4">
      <div className="w-full max-w-sm rounded-2xl border border-gray-100 bg-white p-8 shadow-xl">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-xl font-semibold text-gray-900">Email Job Scheduler</h1>
          <p className="mt-1 text-sm text-gray-500">Schedule and track campaigns at scale.</p>
        </div>
        ...
        <p className="mt-6 text-center text-xs text-gray-400">
          By continuing, you agree this is a demo/hiring-assignment application.
        </p>
      </div>
    </div>
  );
